...
def main():
    for factory in (VanillaProductsFactory(), SecureProductsFactory()):
        prodct_a = factory.create_browser()
        prodct_b = factory.create_messenger()
        prodct_a.create_browser_window()
        prodct_a.create_search_toolbar()
        prodct_b.create_messenger_window()
